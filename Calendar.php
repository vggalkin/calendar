...
class Calendar extends Widget
{
 ...
 <tr>
  <td height="60" class="title" colspan=7>
   <table width="100%" border=0 cellspacing=0 cellpadding=0>
    <tr>
     <td align="left"><a class="c_ajax btn btn-primary" style="margin-left: 10px;" href="' . Url::to('../calendar/index' . $prev . '&id=' . $Id) . '">&lt;&lt;&lt;</a></td>
     <td align="center">' . $month_names[$m - 1] . " " . $y . '</td>
     <td align="right"><a class="c_ajax btn btn-primary" style="margin-right: 10px;" href="' . Url::to('../calendar/index' . $next . '&id=' . $Id) . '">&gt;&gt;&gt;</a></td>
    </tr>
   </table>
  </td>
 </tr>
 ...
 <tr>
  <td height="60" class="title" colspan=7>
   <table width="100%" border=0 cellspacing=0 cellpadding=0>
    <tr>
     <td align="left"><a class="c_ajax btn btn-primary" style="margin-left: 10px;" href="' . Url::to('../calendar/index' . $prev) . '">&lt;&lt;&lt;</a></td>
     <td align="center">' . $month_names[$m - 1] . " " . $y . '</td>
     <td align="right"><a class="c_ajax btn btn-primary" style="margin-right: 10px;" href="' . Url::to('../calendar/index' . $next) . '">&gt;&gt;&gt;</a></td>
    </tr>
   </table>
  </td>
 </tr>
